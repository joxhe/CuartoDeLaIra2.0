const servicios = [
  {
    ...
    desc: 'Evaluación psicométrica rápida que identifica tu estado emocional y te dirige al espacio más adecuado.',
  },
  {
    num: '02',
    icon: '🏛️',
    title: 'Experiencias de catarsis',
    desc: 'Tres ambientes únicos diseñados para diferentes necesidades emocionales, desde la descarga física hasta la relajación profunda.',
  },
  {
    num: '03',
    icon: '🌱',
    title: 'Seguimiento y bienestar',
    desc: 'Acompañamiento posterior con herramientas prácticas para sostener el equilibrio emocional en el día a día.',
  },
]
